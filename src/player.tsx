  ...
  useEffect(() => {
    ...
    wavesurfer.once("ready", () => {
      ...
      if (wavesurfer.getDuration() >= 3600) {
        setDuration(
          new Date(wavesurfer.getDuration() * 1000).toISOString().slice(11, 19)
        );
      } else {
        setDuration(
          new Date(wavesurfer.getDuration() * 1000).toISOString().slice(14, 19)
        );
      }
    });
  ...
  return (
    <div className={`whatsapp-player${dark ? " whatsapp-player__dark" : ""}`}>
      <div className="whatsapp-player__main">
        ...
        <div
          className="whatsapp-player__playback-rate"
